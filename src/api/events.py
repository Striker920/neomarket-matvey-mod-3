...
def receive_product_event(
    ...
    - 409 Conflict — дублирующее событие (тот же idempotency_key)
    - 401 Unauthorized — отсутствует/неверный X-Service-Key
    - 422 Unprocessable Entity — невалидная схема события
    """
